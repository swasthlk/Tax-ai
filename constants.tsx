...
export const TAX_ALLOCATION_DATA = [
  { name: 'Education', value: 35, color: '#00d4ff' },
  { name: 'Healthcare', value: 30, color: '#ff00aa' },
  { name: 'Infrastructure', value: 15, color: '#00ff9d' },
  { name: 'Defense', value: 12, color: '#ffb300' },
  { name: 'Others', value: 8, color: '#9d00ff' },
];
